...
ENEMY_LIST1=[('rifle',5),('machinegun',3)]
ENEMY_LIST2=[('rifle',5),('machinegun',2),('grenade',2)]
ENEMY_LIST3=[('rifle',6),('machinegun',3),('mortar',2)]
ENEMY_LIST4=[('mortar',3),('sniper',1),('rifle',3)]
ENEMY_GROUPS=[ENEMY_LIST1,ENEMY_LIST2,ENEMY_LIST1,ENEMY_LIST3,ENEMY_LIST4]
INTRA_GROUP_PAUSE=800
...
LEVEL_TITLE='Sieged'
LEVEL_TEXTS=[\
        'Somehow you ended up being sieged (desperate in making up the story).',
	'They are charging from all directions.',
        ' ',
	'Guide them into your trench maze, and defence your bedroom.',
	' '
        ]
